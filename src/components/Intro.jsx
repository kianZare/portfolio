      ...
      <section className="relative flex w-full max-w-6xl justify-between object-cover">
        <div className="flex flex-col justify-center p-4 z-10 ">
          ...
          <span className="text-blue-800 md:text-slate-100 text-2xl font-semibold md:text-3xl">
            I'm a skilled and passionate web developer in JavaScript, React,
            HTML, CSS and TailwindCSS to create responsive and user-friendly
            websites.
          </span>
          <br />
          <br />
          <button className="border sm:max-w-[240px] mb-10 p-2 px-4 rounded-xl bg-slate-300 text-slate-800 font-bold flex justify-center items-center gap-3 text-xl hover:text-yellow-400 hover:bg-slate-600"           onClick={() => {
            document
