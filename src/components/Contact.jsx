  ...
  return (
    <div className="flex w-full max-w-6xl justify-center items-center ">
        <section className='flex flex-col justify-center items-center mt-20 w-full max-w-3xl p-4'>
            ...
            <span className='flex justify-center items-center p-2 text-xl '>Please fill out the form below to discuss any work opportunites</span>
            <form className='flex flex-col w-[90vw] max-w-2xl text-lg'>
                <input type="text" placeholder='Your Name' className='border h-10 px-4 py-7 bg-slate-700 m-1 rounded-lg'/>
                <input type="text" placeholder='Your Email' className='border h-10 px-4 py-7 bg-slate-700 m-1 rounded-lg'/>
                <textarea name="message"  rows="5" placeholder='Your Message' className='p-4 bg-slate-700 m-1 rounded-lg'></textarea>
                ...
                <div className="flex justify-center items-center p-4 mt-8">
                    ...
                    <img className="flex w-[71px] md:w-[107px] m-1 hover:scale-110" src={phone} alt="phone" />
